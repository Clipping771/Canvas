...
class _ParticleEngineState extends State<ParticleEngine>
  ...
  // Use a ChangeNotifier to signal repaints without rebuilding the widget tree
  ...
  _Particle _createParticle(EasterEggEffect effect, {bool initial = false}) {
    ...
    if (effect == EasterEggEffect.rain) {
      ...
      p.color = Colors.blue.withValues(alpha: 0.4 + _rnd.nextDouble() * 0.3);
      ...
      p.color = Colors.white.withValues(alpha: 0.6 + _rnd.nextDouble() * 0.4);
      ...
      p.color = Colors.pinkAccent.withValues(
        alpha: 0.7 + _rnd.nextDouble() * 0.3,
      );
  ...
  void _updateParticles(double currentTime) {
    ...
    // Update particle math without triggering widget rebuild
    ...
    // Notify the painter to repaint only
...
class _ParticlePainter extends CustomPainter {
  ...
  _ParticlePainter(this.particles, this.effect, {super.repaint});
