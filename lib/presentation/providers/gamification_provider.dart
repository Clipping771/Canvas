...
class GamificationNotifier extends Notifier<GamificationState> {
  static const String _xpKey = 'vinci_xp';
  static const String _achievementsKey = 'vinci_achievements';
  ...
  Future<void> init() async {
    ...
    final skills = prefs.getStringList('vinci_skills')?.toSet() ?? {};
  ...
  Future<void> _saveState() async {
    ...
    await prefs.setStringList('vinci_skills', state.unlockedSkills.toList());
  }
