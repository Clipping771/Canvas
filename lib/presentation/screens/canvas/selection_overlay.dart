...
class TransformSelectionOverlay extends StatefulWidget {
  ...
  final VoidCallback? onApplyGravity;
  final VoidCallback? onStopPhysics;
  final bool isPhysicsActive;
                  ...
                  child: Material(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (widget.onApplyGravity != null &&
                            widget.onStopPhysics != null) ...[
                          Container(
                            width: 1,
                            height: 20,
                            color: Colors.grey.shade300,
                          ),
                          widget.isPhysicsActive
                              ? IconButton(
                                  icon: const Icon(
                                  ...
                                  onPressed: widget.onStopPhysics,
                                  iconSize: 20,
                                  padding: const EdgeInsets.all(8),
                                  constraints: const BoxConstraints(),
                                )
                              : IconButton(
                                  ...
                                  onPressed: widget.onApplyGravity,
                                  iconSize: 20,
                                  padding: const EdgeInsets.all(8),
                                  constraints: const BoxConstraints(),
                                ),
