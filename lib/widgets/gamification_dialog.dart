...
class GamificationDialog extends ConsumerWidget {
            ...
            Flexible(
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  final reqLvl = GamificationNotifier.skillLevelRequirements[skillId] ?? 99;
                  final isUnlocked = state.unlockedSkills.contains(skillId) || state.level >= reqLvl;
                  final isNext = reqLvl > state.level && (reqLvl - state.level) == 1;
  ...
  Widget _buildSkillItem({
    ...
    final iconColor = isHighlight ? const Color(0xFF3B82F6) : const Color(0xFFCBD5E1);
    final titleColor = isHighlight ? const Color(0xFF2A3A5E) : const Color(0xFF4A6078);
    final subtitleColor = isHighlight ? const Color(0xFF4A6078) : const Color(0xFF8B9EB7);
        ...
        child: Row(
          children: [
                ...
                if (!isUnlocked)
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: const Icon(Icons.lock, size: 10, color: Color(0xFF94A3B8)),
                    ),
                  ),
              ],
            ),
            ...
            Text(
              trailingText,
              style: TextStyle(
                color: isHighlight ? const Color(0xFF3B82F6) : const Color(0xFF8B9EB7),
                fontSize: 12,
                fontWeight: FontWeight.w700,
              ),
            ),
