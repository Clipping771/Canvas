...
import 'package:notesketch_pro/models/stroke.dart';
import 'package:notesketch_pro/providers/drawing_provider.dart';
import 'package:notesketch_pro/models/tool_type.dart';
...
void main() {
  group('AI Feature Pipeline Proof of Work', () {
    test('1. Physics engine toggles properly via apply_gravity', () {
      ...
      // Add a stroke
      notifier.addStrokes([
        Stroke(points: [const Offset(10, 10)], color: Colors.black, size: 2.0, toolType: ToolType.pen, groupId: 'target_group')
      ]);
      ...
      print("✅ apply_gravity successfully activates physics simulation on target objects.");
    });
    ...
    test('2. eraseRect handles proper deletion', () {
      ...
      // Add strokes
      notifier.addStrokes([
        Stroke(points: [const Offset(50, 50), const Offset(100, 100)], color: Colors.black, size: 2.0, toolType: ToolType.pen)
      ]);
      ...
      print("✅ erase_rect correctly computes bounds and deletes objects.");
    });
  });
}
